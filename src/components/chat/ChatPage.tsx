  ...
  return (
    <div className="relative h-screen flex overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <div className="h-16 flex items-center justify-between px-4 sm:px-6 shrink-0 z-10 bg-[#080808]/80 backdrop-blur-xl border-b border-[#351818]">
          <div className="flex items-center gap-3">
            {sidebarCollapsed && (
              <button onClick={() => setSidebarCollapsed(false)}
                className="p-2 rounded-lg text-muted-foreground hover:text-primary hover:bg-[#281515] transition-colors">
                ...
                >
                  {[
                    ...
                    <button
                      ...
                      className="group flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-[#141010] hover:bg-[#281515] border border-[#351818] hover:border-[#ef4444]/40 transition-all"
                    >
