...
export default function ChatSidebar({
  ...
  return (
    <motion.div
      ...
      className={`h-full shrink-0 flex flex-col bg-[#0d0d0d]/95 backdrop-blur-xl overflow-hidden ${collapsed ? 'border-none' : 'border-r border-[#351818]'}`}
    >
      <div className="p-4 flex items-center justify-between shrink-0 h-14">
        {!collapsed && (
          <div className="flex items-center gap-2">
             <div className="w-8 h-8 rounded-full bg-[#ef4444]/10 border border-[#ef4444]/30 flex items-center justify-center">
        ...
        <button
          onClick={onToggle}
          className="p-1.5 rounded-lg text-[#a1a1aa] hover:text-white hover:bg-[#281515] transition-all ml-auto"
      ...
      <div className="px-3 pb-3 shrink-0 mt-2">
        <button
          onClick={onNewChat}
          className="w-full flex items-center gap-3 px-3 py-3 rounded-xl bg-[#dc2626] hover:bg-[#ef4444] hover:shadow-[0_0_20px_rgba(239,68,68,0.25)] text-white transition-all font-medium text-[14px]"
        >
      ...
      <div className="p-3 shrink-0 border-t border-[#333537] mt-auto">
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#a1a1aa] hover:text-white hover:bg-[#281515] transition-all text-sm font-medium"
        >
